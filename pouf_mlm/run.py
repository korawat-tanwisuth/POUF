...
class ModelArguments:
    ...
    lambda_transport: float = field(
        default=1.0,
        metadata={"help": "coefficient in front of the transport loss."}
    )

    lambda_im: float = field(
        default=0.6,
        metadata={"help": "coefficient in front of the im loss."}
    )

    t: float = field(
        default=10,
        metadata={"help": "temperature in the transport plan."}
    )

    unsup: bool = field(
        default=False,
        metadata={"help": "Whether to perform unsupervised learning."}
    )
